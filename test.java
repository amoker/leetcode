...
public class test {
    ...
    public String nearestPalindromic(String n) {
        ...
        int plus = (int) Math.pow(10, (n.length()-1)/2);
        String b = mirroring(Long.toString(num-plus));
        String c = mirroring(Long.toString(num+plus));
        Long diff1 = Math.abs(Long.parseLong(a) - num);
        if(diff1 == 0) diff1 = Long.MAX_VALUE;
        Long diff2 = Math.abs(Long.parseLong(b) - num);
        Long diff3 = Math.abs(Long.parseLong(c) - num);
